...
bool isStartPointInRange() { return sc > 0 && sr > 0 && sc <= n && sr <= n; }

bool isEndPointInRange() { return ec > 0 && er > 0 && ec <= n && er <= n; }

bool isPointInRange() { return isStartPointInRange() && isEndPointInRange(); }
