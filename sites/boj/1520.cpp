...
bool isVisited(int row, int col) { return dp[row][col] != NOT_VISITED; }

bool isReached(int row, int col) { return row == m && col == n; }

int getPositionValue(int row, int col) { return map[row][col]; }
